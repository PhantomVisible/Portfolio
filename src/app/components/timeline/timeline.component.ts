...
export class TimelineComponent implements AfterViewInit {
  ...
  timelineItems = [
    ...
    },
    {
      ...
      org: 'Bach Media',
      desc: 'Running an independent media studio handling script refinement, brand identity design, and Shopify-based digital media services.',
      tags: ['Brand Design', 'Shopify', 'Script & Copy', 'Media'],
      highlight: true,
    },
  ];
